...
#define LCD_ENTRY_MODE_INCREMENT_ADDR				0x02
#define LCD_ENTRY_MODE_DECREMENT_ADDR				0x00
...
#define LCD_INSTRUCTION_SHIFT						0x10
#define LCD_SHIFT_DISPLAY_SHIFT						0x08
#define LCD_SHIFT_CURSOR_MOVE						0x00
...
#define LCD_INSTRUCTION_SET_CGRAM_ADDR				0x40

#define LCD_INSTRUCTION_SET_DDRAM_ADDR				0x80

typedef enum
{
	LCD_INSTRUCTION_REGISTER = 0, LCD_DATA_REGISTER
} LCD_CommandReg;
